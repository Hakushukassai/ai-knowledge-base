window.STATS_DATA = {
  "generated_at": "2026-08-31T06:22:14Z",
  "rules": {
    "count": 1,
    "chars": 780
  },
  ...
  "history": [
    ...
    {
      "date": "2026-08-24T05:13:22Z",
      "summary": "記録を開始しました(既存 11件)",
      "rules_count": 1,
      "candidates_count": 9,
      "incidents_count": 1,
      "total_chars": 11846
    ...
    {
      "date": "2026-08-24T05:17:40Z",
      "summary": "[候補] Claude Codeは自分自身の`~/.claude/settings.json`を書き換えられない / [候補] `gh auth login`はClaude Code経由ではなく独立したターミナルで実行する必要がある",
      "rules_count": 1,
      "candidates_count": 11,
      "incidents_count": 1,
      "total_chars": 13841
    ...
    {
      "date": "2026-08-24T09:42:45Z",
      "summary": "[候補] 外部Skill `game-feel` を試験導入 / [候補] 外部Skill `godot-ui-control` を試験導入",
      "rules_count": 1,
      "candidates_count": 21,
      "incidents_count": 1,
      "total_chars": 25375
    ...
    {
      "date": "2026-08-24T10:02:26Z",
      "summary": "[候補] セッション再開後、`~/Downloads`への読み取りアクセスが拒否されることがある / [候補] 外部Skill `frontend-design`(Anthropic公式)を試験導入 ほか1件",
      "rules_count": 1,
      "candidates_count": 26,
      "incidents_count": 1,
      "total_chars": 31173
    ...
    {
      "date": "2026-08-24T11:19:07Z",
      "summary": "[候補] 誤検知の「説明文」を書く行為自体が同じ誤検知を再発させる",
      "rules_count": 1,
      "candidates_count": 27,
      "incidents_count": 1,
      "total_chars": 31984
    ...
    {
      "date": "2026-08-24T11:41:27Z",
      "summary": "[候補] 外部Skill `godot-signals-groups`を試験導入",
      "rules_count": 1,
      "candidates_count": 30,
      "incidents_count": 1,
      "total_chars": 35039
    ...
    {
      "date": "2026-08-24T11:42:53Z",
      "summary": "[候補] 外部Skill `godot-3d-essentials`を試験導入",
      "rules_count": 1,
      "candidates_count": 31,
      "incidents_count": 1,
      "total_chars": 36082
    ...
    {
      "date": "2026-08-24T16:12:16Z",
      "summary": "[候補] Claude Codeのブラウザツールのネットワーク/コンソールログは、タブの生存期間全体で累積される(ページ遷移でリセ / [候補] Finnhub無料枠は`/quote`(現在値)は使えるが`/stock/candle`(過去足)は使えない ほか3件",
      "rules_count": 1,
      "candidates_count": 37,
      "incidents_count": 1,
      "total_chars": 43481
    ...
    {
      "date": "2026-08-24T16:33:02Z",
      "summary": "[候補] 「テンプレっぽくしないで」という指示やアンチテンプレのガイドラインがあっても、ダーク×ネオン発光×パネル系のUIに収束す",
      "rules_count": 1,
      "candidates_count": 38,
      "incidents_count": 1,
      "total_chars": 45591
    ...
    {
      "date": "2026-08-28T13:39:10Z",
      "summary": "[候補] 差分の改ざん検知には、集計統計(変更行数など)ではなくgit write-treeのツリーハッシュを比較する方が同じ形の / [候補] GDScript: `SceneTree.quit()`は即座に処理を中断しない(呼んだ後も関数の残りが実行され続け、後 ほか4件",
      "rules_count": 1,
      "candidates_count": 38,
      "incidents_count": 1,
      "total_chars": 66572
    ...
    {
      "date": "2026-08-28T16:10:14Z",
      "summary": "[候補] GDScript: 比較式の右辺に`[...] as Array[T]`を書くと「Invalid cast. Canno / [候補] Godot: スポーン関数が`add_child.call_deferred`だと、直後にシーンツリーを走査するテストは ほか2件",
      "rules_count": 1,
      "candidates_count": 42,
      "incidents_count": 1,
      "total_chars": 71941
    ...
    "candidates": [
      {
        ...
        "days_old": 2,
        "stale": false,
        "problem_summary": "アイテムの永続個体ID(instance_id)を導入する際、「袋・装備・倉庫・地面・セーブ(JSON)・ネットワーク通信のすべてで同じIDを使う」仕様にした。IDは衝突回避のため…",
        "solution_summary": "IDの採番を最初から**53bit未満に収まる構成**で設計した(乱数30bit + マイクロ秒下位10bit + 連番10bit + 識別用の1bit = 51bit)。 ```…",
        "observed_count": 1,
        "endorsed": false,
        "reference_count": 0,
        "reference_recent": [],
      ...
      },
      {
        ...
        "days_old": 2,
        "stale": false,
        "problem_summary": "インベントリUIで「同じ決定ボタンでも、パッド(A)なら『持つ』、キーボード(Enter)なら『装備』」と挙動を分けるため、最初は次のポーリングで判定していた: ```gdscri…",
        "solution_summary": "判定を「デバイスのポーリング」から「**直前に届いた入力イベントの種別の記録**」へ変えた。UIコントロールがイベントを消費する前に必ず通る`_input()`で記録する: ```…",
        "observed_count": 1,
        "endorsed": false,
        "reference_count": 0,
        "reference_recent": [],
      ...
      },
      {
        ...
        "days_old": 2,
        "stale": false,
        "problem_summary": "ボス撃破報酬が「確定でユニーク装備のPickupを床に出す」ことを検証するSceneTreeテストで、報酬付与関数を同期呼び出しした直後に`$Actors`の子ノードを走査してPi…",
        "solution_summary": "ゲーム側のスポーン関数(`_spawn_pickup`)は物理コールバック中のツリー変更エラーを避けるために`$Actors.add_child.call_deferred(pic…",
        "observed_count": 1,
        "endorsed": false,
        "reference_count": 0,
        "reference_recent": [],
      ...
      },
      {
        ...
        "days_old": 2,
        "stale": false,
        "problem_summary": "テストコードで「関数の戻り値が特定の型付き配列と等しいか」を1行で書いた: ```gdscript if ClassData.unlocked_classes() != [&\"ke…",
        "solution_summary": "GDScriptでは`as`の優先順位が比較演算子(`!=`)より低く、`(a != [...]) as Array[StringName]`と解釈される。比較結果のboolを型付…",
        "observed_count": 1,
        "endorsed": false,
        "reference_count": 0,
        "reference_recent": [],
  ...
  "skills": [
    ...
    {
      "folder_name": "godot-3d-essentials",
    ...
    {
      "folder_name": "godot-signals-groups",
    ...
    {
      "folder_name": "ui-design-resources",
